...
exports.lookup_auth_member_following = (mb_id) => {
  return {
    $lookup: {
      from: "follows",
      let: {
        lc_follow_id: "$subscriber_id", //teskari yozish follow qismi
        lc_subscriber_id: mb_id,
        nw_my_following: true, //check qilish maqsadida yozilgan
      },
      pipeline: [
        {
          $match: {
        ...
        },
        {
          $project: {
            _id: 0,
            subscriber_id: 1, //1 soni projectionga ol degani
            follow_id: 1,
